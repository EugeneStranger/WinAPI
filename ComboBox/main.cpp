...
BOOL CALLBACK DlgProc(HWND hwnd, UINT uMsg, WPARAM wParam, WPARAM lParam)
{
	//HWND - Hndler to Window (Обработчик окна)
	//uMsg - Unsigned Message (имеется ввиду, что 'Message' - это беззнаковая переменная) - Сообщение
	//wParam, lParam - параметры сообщений
	switch (uMsg)
	{
	case WM_INITDIALOG:
	{
